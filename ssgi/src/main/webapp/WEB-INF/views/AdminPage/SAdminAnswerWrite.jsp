...
<body>
	...
	<div class="container" id="b">
		...
		<%-- <div class="card ">
			<div class="card-body ">
				<form action="SAdminAnswerWriteOK" method="post"
					class="needs-validation" novalidate>
					<input type="hidden" name="AS_QNA_NUM" class="form-control" value="${dto.AS_QNA_NUM}">
					<div class="form-group">
						<label for="AS_QNA_TITLE">문의하신
							제목:&nbsp;${dto.AS_QNA_TITLE}</label>
					</div>
					<hr>
					<div class="form-group">
						<!-- <label for="AS_QNA_TITLE"><input type="text" name="AU_QNA_ANSWER">여기에 답변한거 쓸거임</label> -->
						<textarea cols="300" rows="20" class="form-control" name="AS_QNA_ANSWER" placeholder="내용입력"  onkeyup="chkword(this,500)" required></textarea>
					</div>
					<div class="form-group">
						<label>답변완료라고 입력해주세요</label> <input id="OKCeck" type="text" name="AS_QNA_READ" placeholder="'답변완료'라고 입력해주세요" class="form-control"  onkeyup="chkword(this,4)" required>
		...
		<div class="card ">
			<div class="card-body ">
				<form action="SAdminAnswerWriteOK" method="post" class="needs-validation" novalidate>
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
					...
					<div class="form-group">
					    ...
					    <input  type="text" id="AS_QNA_READ" placeholder="'답변완료'라고 입력해주세요"  name="AS_QNA_READ"  class="form-control"  onkeyup="chkword(this,4)" required>
...
// 아이디 유효성 검사(1 = 중복 / 0 != 중복)
	$("#AS_QNA_READ").blur(function() {
		// id = "id_reg" / name = "userId"
		var AS_QNA_READ = $('#AS_QNA_READ').val();
		$.ajax({
			url : '${pageContext.request.contextPath}/SAdminQNA/OKCheck?AS_QNA_READ='+ AS_QNA_READ,
			type : 'get',
