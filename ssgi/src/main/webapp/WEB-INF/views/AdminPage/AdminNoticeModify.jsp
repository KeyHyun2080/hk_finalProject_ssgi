...
<h3 align="center">글 수정</h3>
	...
	<div class="container">
		...
		<form action="NoticeModifyOK" method="post">
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
			<div class="form-group">
			<input type="hidden" name="NOTICE_NUM"  class="form-control"  value="${dto.NOTICE_NUM}" >
				<label>제목</label> 
				<input type="text" name="NOTICE_TITLE" class="form-control" value="${dto.NOTICE_TITLE}" onkeyup="chkword(this,40)">
			</div>
			<div class="form-group">
				<label >내용</label>
				<textarea cols="300"rows="25" class="form-control" name="NOTICE_CONTENT" onkeyup="chkword(this,500)">${dto.NOTICE_CONTENT}</textarea>
			</div>
			<button type="submit" class="btn btn-primary">&nbsp;&nbsp; 전송 &nbsp;&nbsp;</button>	
			<a href="AdminNoticeDetail" class="btn btn-warning">취소</a>
		</form>
