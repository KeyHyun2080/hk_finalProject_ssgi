...
<h3 align="center">글 수정</h3>
	...
	<div class="container">
		...
		<form action="myQNAModifyOK" method="post">
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
			<div class="form-group">
			<input type="hidden" name="AU_QNA_NUM"  class="form-control"  value="${dto.AU_QNA_NUM}" >
				<label>제목</label> 
				<input type="text" name="AU_QNA_TITLE" class="form-control" value="${dto.AU_QNA_TITLE}"  onkeyup="chkword(this,40)">
			</div>
			<div class="form-group">
				<label >내용</label>
				<textarea cols="300"rows="25" class="form-control" name="AU_QNA_CONTENT"  onkeyup="chkword(this,500)">${dto.AU_QNA_CONTENT}</textarea>
			</div>
			<button type="submit" class="btn btn-primary">&nbsp;&nbsp; 전송 &nbsp;&nbsp;</button>	
			<a href="myPage" class="btn btn-warning">취소</a>
		</form>
