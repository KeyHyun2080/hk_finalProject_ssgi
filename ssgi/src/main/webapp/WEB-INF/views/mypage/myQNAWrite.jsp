...
<body>
	...
	<div class="container">
		...
		<form action="myQNAWriteYes" method="post" class="needs-validation" novalidate>
			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
			<input type="hidden" name="USER_ID"  class="form-control"  value="${user_id }">
			<div class="form-group">
				<label >제목 입력</label> 
				<input type="text" name="AU_QNA_TITLE" placeholder="제목입력" onkeyup="chkword(this,40)" class="form-control" required>
				<div class="invalid-feedback">제목을 입력해주세요!</div>
			</div>
			<div class="form-group">
				<label >내용 입력</label>
				<textarea  cols="300" rows="25" class="form-control" name="AU_QNA_CONTENT" onkeyup="chkword(this,500)" placeholder="내용입력" required></textarea>
