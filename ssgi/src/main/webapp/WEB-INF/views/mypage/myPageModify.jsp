...
<body>
		...
		<br> <a>이름: ${dto.user_name }</a><br>	              
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="user_pw" id="user_pw" value="${dto.user_pw }">
                    </div>
                    
                    <div class="form-group">
                        <label for="inputPassword">비밀번호 확인</label>
                        <input type="password" class="form-control" name="user_chk" id="user_chk" value="${dto.user_pw }" >
                    </div>	
					 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="user_addr2"  id="user_addr2" value="${dto.user_addr2 }">                 
                    </div> 
