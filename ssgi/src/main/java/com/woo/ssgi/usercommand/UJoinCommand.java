...
public class UJoinCommand implements UCommand{
	BCryptPasswordEncoder passwordEncoder;	//암호화클래스
	@Autowired	//생성자로 해주어야 에러없음 servlet-context.xml에 bean등록
	public UJoinCommand(BCryptPasswordEncoder passwordEncoder) {
...
//		request = (HttpServletRequest)map.get("request");
		...
		dao.join(user_id,user_pw,user_name,user_addr,user_addr2,user_ph,user_email);	
